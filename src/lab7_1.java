...
public class lab7_1 {
    private static final String FILE_PATH = "C:\\Users\\email\\IdeaProjects\\JLAB7_1\\src\\input.txt";
    ...
    private static int calculateTotalAudience(List<Performance> performances) {
        int totalAudience = 0;
        for (Performance performance : performances) {
            totalAudience += performance.audienceCount;
        }
    ...
    private static String findDayWithMaxAudience(List<Performance> performances) {
        ...
        int maxAudience = 0;
        for (Performance performance : performances) {
            if (performance.audienceCount > maxAudience) {
                maxAudience = performance.audienceCount;
                maxDay = performance.date;
            }
        }
        return maxDay;
    }
    ...
    private static void displayLastNameLengths(List<Writer> writers) {
        ...
        for (Writer writer : writers) {
            System.out.println(writer.lastName + ": " + writer.lastName.length());
        }
    }
